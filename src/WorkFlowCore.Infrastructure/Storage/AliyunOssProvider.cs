...
/// <summary>
/// 阿里云OSS存储提供者（基于 ABP BlobStoring.Aliyun）
...
public class AliyunOssProvider : IStorageProvider
{
    ...
    private readonly ILogger<AliyunOssProvider> _logger;

    public AliyunOssProvider(
        IBlobContainer<FileStorageBlobContainer> blobContainer,
        ILogger<AliyunOssProvider> logger)
    {
    ...
    {
        // ABP BlobStoring 的 Aliyun 提供者支持预签名 URL，这里简化返回
